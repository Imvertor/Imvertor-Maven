...
public class MIMCompiler extends Step {
	...
	public boolean generateDefault() throws Exception {
		...
		String mcv = configurator.getXParm("system/mim-configured-version", false); // major.minor: wordt bepaald op basis van de actieve configuratie.
		String mv = configurator.getXParm("appinfo/metamodel-version", false); // major.minor: wordt bepaald op basis van de actieve configuratie.
