...
public class EapCompiler extends Step {
	...
	public boolean run() throws Exception{
		...
		if (!umlfile.getExtension().equals("")) {
			boolean iseap = umlfile.getExtension().startsWith("eap") || umlfile.getExtension().equals("qea");
			...
			if (iseap || isxmi || iszip) {
				...
				runner.warn(logger,"Unexpected extension for UML file: " + umlfile.getExtension(),null,"UEFUF");
		}
