...
public class SetNamedCount extends ExtensionFunctionDefinition {

	private static final StructuredQName qName = new StructuredQName("", "http://www.imvertor.org/xsl/extensions", "set-named-count");
