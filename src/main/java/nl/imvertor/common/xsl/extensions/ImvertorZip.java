...
*
*/
public class ImvertorZip extends ExtensionFunctionDefinition {

	private static final StructuredQName qName = new StructuredQName("", Configurator.NAMESPACE_EXTENSION_FUNCTIONS, "imvertorZip");
	...
	public ExtensionFunctionCall makeCallExpression() {
		return new ImvertorZipCall();
	}

	private static class ImvertorZipCall extends ExtensionFunctionCall {
