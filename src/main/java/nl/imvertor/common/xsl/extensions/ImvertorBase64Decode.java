 ...
 */
public class ImvertorBase64Decode extends ExtensionFunctionDefinition {

  private static final StructuredQName qName = 
      new StructuredQName("", Configurator.NAMESPACE_EXTENSION_FUNCTIONS, "imvertorBase64Decode");
  ...
  private static class Base64DecodeCall extends ExtensionFunctionCall {
    ...
    public StringValue call(XPathContext context, Sequence[] arguments) throws XPathException {            
      try {
        String str = StringUtils.deleteWhitespace(((StringValue) arguments[0].head()).getStringValue());        
