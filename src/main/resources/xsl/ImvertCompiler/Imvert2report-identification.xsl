        ...
        <row xmlns="">
            ...
            <cell>
                <xsl:choose>
                    ...
                    <xsl:when test="$superclasses/imvert:stereotype/@id = ('stereotype-name-objecttype','stereotype-name-koppelklasse')">inherit</xsl:when>
                    <xsl:when test="imvert:stereotype/@id = ('stereotype-name-objecttype','stereotype-name-koppelklasse')">yes</xsl:when>
                </xsl:choose>
            </cell>
        </row>
    </xsl:template>
