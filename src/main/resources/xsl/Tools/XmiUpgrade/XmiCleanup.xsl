...
<xsl:stylesheet 
    ...
    <xsl:template match="documentation">
        <documentation value="{concat('&#xA;&#xA;--&#xA;', @value)}"/>
    </xsl:template>
    
    <xsl:template match="properties/@documentation">
        <xsl:attribute name="documentation" select="concat('&#xA;&#xA;--&#xA;', .) "/>
    </xsl:template>
    ...
    <xsl:template match="/xmi:XMI/xmi:Extension/elements/element[@xmi:type='uml:Package' and properties/@stereotype[lower-case(.) = 'extern']]/tags">
    ...
    <xsl:template match="/xmi:XMI/xmi:Extension/elements/element[@xmi:type='uml:Package' and properties/@stereotype[lower-case(.) = ('toepassing','basismodel')]]/tags">
    ...
    <xsl:template match="/xmi:XMI/xmi:Extension/elements/element[@xmi:type='uml:Package' and properties/@stereotype[lower-case(.) = 'domein']]/tags">
    ...
    <xsl:function name="imf:insert-tagged-value">
        ...
        <xsl:choose>
            <xsl:when test="exists($existing-tagged-value)">
                <tag name="{$name}" value="{$empty-value}" xmi:id="{$existing-tagged-value/@xmi:id}">
