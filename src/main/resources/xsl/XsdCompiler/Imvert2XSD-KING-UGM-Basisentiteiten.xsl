    ...
    <xsl:template match="imvert:packages">
        ...
        <xsl:variable name="schema" as="element()">
            <xs:schema 
                ...
                <xs:annotation>
                    <xs:documentation>(Declaratie van niet-simpletype attributen)</xs:documentation>
                </xs:annotation> 
                <xsl:for-each-group 
                ...
                <xs:annotation>
                    <xs:documentation>(Declaratie van externe typen)</xs:documentation>
                </xs:annotation> 
                <xsl:for-each-group 
        ...
        <xs:complexType name="{$associatie-naam}-basis">
            ...
            <xs:choice>
                ...
                <xs:sequence>
                    ...
                    <xsl:if test="imf:property-is-authentiek(.)">
                        <!-- avoid duplicates -->
                        <xs:element name="authentiek" type="{$StUF-prefix}:StatusMetagegeven-basis" minOccurs="0" maxOccurs="unbounded"/><!-- DONE bg:authentiek-TODO -->
                    </xsl:if>
                    <xsl:if test="imf:property-is-in-onderzoek(.)">
                        <xs:element name="inOnderzoek" type="{$StUF-prefix}:StatusMetagegeven-basis" minOccurs="0" maxOccurs="unbounded"/>
                    </xsl:if>
                    ...
                    <xsl:if test="exists($association-class) and imf:is-authentiek($association-class)">
                        <xs:element name="authentiek" type="{$StUF-prefix}:StatusMetagegeven-basis" minOccurs="0" maxOccurs="unbounded"/> 
                    </xsl:if>
                    <!-- TODO https://kinggemeenten.plan.io/issues/488563 -->
                    <xsl:if test="exists($association-class) and imf:is-in-onderzoek($association-class)">
                        <xs:element name="inOnderzoek" type="{$StUF-prefix}:StatusMetagegeven-basis" minOccurs="0" maxOccurs="unbounded"/>
                    </xsl:if>
