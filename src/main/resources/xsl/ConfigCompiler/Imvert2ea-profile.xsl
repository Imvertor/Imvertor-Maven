...
<xsl:stylesheet 
    ...
    <xsl:template match="/config">
        ...
        <xsl:variable name="categories" select="metamodel/profiles/category"/>
        ...
        <xsl:variable name="toolbox">
            <UMLProfile profiletype="uml2">
                ...
                <Content>
                    <Stereotypes>
                        <xsl:variable name="prefix" select="$metamodel/profiles/visual-name/name"/>
                        <xsl:for-each-group select="$visuals/toolbox" group-by="@category">
