            ...
            <content>
                <div>
                    ...
                    <table class="tablesorter"> 
                        ...
                        <xsl:sequence select="imf:create-result-table-by-tr($rows,'Stereotype(s):45,Allowed on:45,In metamodel:10','table-meta')"/>
                    </table>
                </div>
                <div>
                    <h1>Tagged values</h1>
                    ...
                    <table class="tablesorter"> 
                        ...
                        <xsl:sequence select="imf:create-result-table-by-tr($rows,'tagged value name(s):45,allowed on stereotype(s):45,tagset:10','table-tvset')"/>
                    </table>
                </div>
